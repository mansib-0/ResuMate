        ...
        <div className="glass-panel" style={{ width: "400px", padding: "2.5rem" }}>
          ...
          <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              <label style={{ fontSize: "0.9rem", color: "rgba(255,255,255,0.8)" }}>Unique Username</label>
              <input 
                type="text" 
                required
                value={username}
          ...
          <p style={{ marginTop: "1.5rem", textAlign: "center", fontSize: "0.9rem", color: "rgba(255,255,255,0.6)" }}>
            Already have an account? <Link href="/login" style={{ color: "var(--primary)", textDecoration: "underline" }}>Log in here</Link>
          </p>
        </div>
      </main>
    </div>
